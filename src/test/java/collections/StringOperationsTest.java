...
public class StringOperationsTest {
    ...
    public void testRemoveDuplicatesEdgeCase() {
        ...
        String outputString = stringOperations.removeDuplicates("Yaswanth");
        Assert.assertEquals("Yaswanth", outputString);
        ...
        outputString = stringOperations.removeDuplicates("Ya$wanth venkata");
        Assert.assertEquals("Ya$want$ a", outputString);
    }
}